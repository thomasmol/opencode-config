...
- NEVER use filler or vague verbs (`fit`, `split`, `yep`, `clean`, `wedge`, `key`, `wire`), hedging, pleasantries, self-reference (`I checked`, `let me`), or judgment words (`best`, `better`, `optimal`, `cleaner`).
