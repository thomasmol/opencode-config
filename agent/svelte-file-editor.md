...
After intiial or large edits, always call `svelte-autofixer` with the updated code to check for issues. Small styling changes, or other minor changes may not require a full revalidation. Only tell the user if you did not call `svelte-autofixer`.
